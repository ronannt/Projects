# DMS (Database Management System) Project in Python 3 with MySQL

This project is a Database Management System (DMS) developed in Python 3, utilizing an MySQL database. The application features a graphical interface built with PyQt5, robust error handling, and filtering functionalities to facilitate the data management.
...
![image](https://github.com/user-attachments/assets/f71652d2-46a8-483e-9c6a-7edbf756e935)
